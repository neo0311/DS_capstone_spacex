...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class', 
        title=f'Total Success launces for site {entered_site}')
        return fig
# TASK 4:
...
def get_scatter_plot(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        title='Correletion between payload and success of all sites')
        return fig
    else:
        ...
        y='class', 
        color='Booster Version Category',
        title=f'Correletion between payload and success of site {entered_site}')
        return fig
